...
namespace pacman_v_1._00
{
    ...
    internal class ghost : PictureBox
    {
        ...
        private List<ghostYon> yon = new List<ghostYon>() { ghostYon.left , ghostYon.right , ghostYon.top, ghostYon.bottom };
        ...
        private void ghostAyarlar()
        {
            ...
            this.Location = new Point(700, 14);
            this.Size = new Size(50, 50);
            this.SizeMode = PictureBoxSizeMode.StretchImage;
            alınanForm.Controls.Add(this);
        }
        public void GhostYonTayin(Rectangle pcBox)
        {
            ...
            yon = mesafeler.OrderByDescending(x => x)
                .Select(x => x == mesafeRight ? ghostYon.right : x == mesafeLeft ? ghostYon.left : x == mesafeBottom ? ghostYon.bottom : ghostYon.top).ToList();
        }
        ...
        public void oyunbitti()
        {
            ...
            if (pacman_model.locasyonu.IntersectsWith(this.Bounds))
            {
                ghosttimer.Stop();
                ghosttimer2.Stop();
                oyun = false;
